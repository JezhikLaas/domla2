...
namespace D2.Infrastructure.Test
{
    public class TypedValueTest
    {
        ...
        {
            TypedValue meter = new TypedValue(10, "Meter");
            TypedValue room = new TypedValue(3, "Zimmer");
        ...
        {
            TypedValue meter = new TypedValue(3, "Meter");
            TypedValue room = new TypedValue(10, "Zimmer");
            Assert.Throws<Exception>(() => meter < room);
        }
        ...
        {
            TypedValue meter = new TypedValue(3, "Meter");
            TypedValue meter2 = new TypedValue(3, "Meter");
        ...
        {
            TypedValue meter = new TypedValue(3, "Meter");
            TypedValue room = new TypedValue(3, "Room");
            Assert.Throws<Exception>(() => meter >= room);
        }
